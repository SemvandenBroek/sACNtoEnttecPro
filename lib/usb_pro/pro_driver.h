...
uint8_t FTDI_SendData(uint8_t label, unsigned char *data, uint32_t length);
uint8_t FTDI_ReceiveData(uint8_t label, unsigned char *data, uint32_t expected_length);
